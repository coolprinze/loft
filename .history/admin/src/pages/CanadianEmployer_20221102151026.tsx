...
const CanadianEmployer = (_: {
  ...
  const getEmployers = () => async (dispatch: Dispatch, getState: any) => {
    try {
      const {
        auth: { token },
      } = getState()
      ...
      <Row>
        ...
        <Col sm={4}>
          <CSVLink
            ...
            filename='CanadianEmployer-Immigrants'
          >
            Export to CSV
          </CSVLink>
        </Col>
...
//@ts-ignore
export default connect(mapStateToProps, { getImmigrants, searchDb })(
  CanadianEmployer
)
